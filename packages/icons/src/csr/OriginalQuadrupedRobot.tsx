...
import weights from "../defs/OriginalQuadrupedRobot";

/** 四足机器人 · 科技 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalQuadrupedRobotIcon";
export { I as OriginalQuadrupedRobotIcon, I as OriginalQuadrupedRobot };
