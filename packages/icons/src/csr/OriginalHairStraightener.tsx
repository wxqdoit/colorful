...
import weights from "../defs/OriginalHairStraightener";

/** 直发夹板 · 个护 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHairStraightenerIcon";
export { I as OriginalHairStraightenerIcon, I as OriginalHairStraightener };
