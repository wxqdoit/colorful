...
import weights from "../defs/OriginalImmersionBlender";

/** 手持搅拌棒 · 厨房 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalImmersionBlenderIcon";
export { I as OriginalImmersionBlenderIcon, I as OriginalImmersionBlender };
