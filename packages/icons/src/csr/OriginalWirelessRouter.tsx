...
import weights from "../defs/OriginalWirelessRouter";

/** 无线路由器 · 科技 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalWirelessRouterIcon";
export { I as OriginalWirelessRouterIcon, I as OriginalWirelessRouter };
