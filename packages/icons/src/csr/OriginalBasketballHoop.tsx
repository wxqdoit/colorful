...
import weights from "../defs/OriginalBasketballHoop";

/** 篮球架 · 运动 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalBasketballHoopIcon";
export { I as OriginalBasketballHoopIcon, I as OriginalBasketballHoop };
