...
import weights from "../defs/OriginalEllipticalTrainer";

/** 椭圆机 · 运动 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalEllipticalTrainerIcon";
export { I as OriginalEllipticalTrainerIcon, I as OriginalEllipticalTrainer };
