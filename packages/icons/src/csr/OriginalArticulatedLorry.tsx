...
import weights from "../defs/OriginalArticulatedLorry";

/** 半挂卡车 · 出行 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalArticulatedLorryIcon";
export { I as OriginalArticulatedLorryIcon, I as OriginalArticulatedLorry };
