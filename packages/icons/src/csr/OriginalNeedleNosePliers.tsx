...
import weights from "../defs/OriginalNeedleNosePliers";

/** 尖嘴钳 · 手作 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalNeedleNosePliersIcon";
export { I as OriginalNeedleNosePliersIcon, I as OriginalNeedleNosePliers };
