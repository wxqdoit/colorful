...
import weights from "../defs/OriginalSeparatoryFunnel";

/** 分液漏斗 · 科学 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSeparatoryFunnelIcon";
export { I as OriginalSeparatoryFunnelIcon, I as OriginalSeparatoryFunnel };
