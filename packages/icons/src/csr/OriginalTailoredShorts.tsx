...
import weights from "../defs/OriginalTailoredShorts";

/** 短裤 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalTailoredShortsIcon";
export { I as OriginalTailoredShortsIcon, I as OriginalTailoredShorts };
