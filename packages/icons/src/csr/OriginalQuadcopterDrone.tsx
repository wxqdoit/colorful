...
import weights from "../defs/OriginalQuadcopterDrone";

/** 四旋翼无人机 · 科技 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalQuadcopterDroneIcon";
export { I as OriginalQuadcopterDroneIcon, I as OriginalQuadcopterDrone };
