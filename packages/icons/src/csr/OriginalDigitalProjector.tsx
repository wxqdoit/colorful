...
import weights from "../defs/OriginalDigitalProjector";

/** 数字投影仪 · 科技 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalDigitalProjectorIcon";
export { I as OriginalDigitalProjectorIcon, I as OriginalDigitalProjector };
