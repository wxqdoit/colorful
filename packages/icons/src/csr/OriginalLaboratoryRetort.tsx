...
import weights from "../defs/OriginalLaboratoryRetort";

/** 曲颈蒸馏瓶 · 科学 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalLaboratoryRetortIcon";
export { I as OriginalLaboratoryRetortIcon, I as OriginalLaboratoryRetort };
