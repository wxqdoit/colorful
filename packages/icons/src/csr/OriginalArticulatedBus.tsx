...
import weights from "../defs/OriginalArticulatedBus";

/** 铰接公交车 · 出行 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalArticulatedBusIcon";
export { I as OriginalArticulatedBusIcon, I as OriginalArticulatedBus };
