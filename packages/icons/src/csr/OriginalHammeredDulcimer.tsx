...
import weights from "../defs/OriginalHammeredDulcimer";

/** 扬琴 · 艺术 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHammeredDulcimerIcon";
export { I as OriginalHammeredDulcimerIcon, I as OriginalHammeredDulcimer };
