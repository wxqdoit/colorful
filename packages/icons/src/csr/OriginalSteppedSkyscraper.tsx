...
import weights from "../defs/OriginalSteppedSkyscraper";

/** 退台高楼 · 建筑 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSteppedSkyscraperIcon";
export { I as OriginalSteppedSkyscraperIcon, I as OriginalSteppedSkyscraper };
