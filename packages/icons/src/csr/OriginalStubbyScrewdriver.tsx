...
import weights from "../defs/OriginalStubbyScrewdriver";

/** 短柄螺丝刀 · 手作 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalStubbyScrewdriverIcon";
export { I as OriginalStubbyScrewdriverIcon, I as OriginalStubbyScrewdriver };
