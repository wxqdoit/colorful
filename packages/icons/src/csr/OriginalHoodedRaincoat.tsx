...
import weights from "../defs/OriginalHoodedRaincoat";

/** 连帽雨衣 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHoodedRaincoatIcon";
export { I as OriginalHoodedRaincoatIcon, I as OriginalHoodedRaincoat };
