...
import weights from "../defs/OriginalEnvelopeClutch";

/** 信封手拿包 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalEnvelopeClutchIcon";
export { I as OriginalEnvelopeClutchIcon, I as OriginalEnvelopeClutch };
