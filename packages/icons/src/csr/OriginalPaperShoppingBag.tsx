...
import weights from "../defs/OriginalPaperShoppingBag";

/** 纸购物袋 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalPaperShoppingBagIcon";
export { I as OriginalPaperShoppingBagIcon, I as OriginalPaperShoppingBag };
