...
import weights from "../defs/OriginalChampionTrophy";

/** 冠军奖杯 · 运动 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalChampionTrophyIcon";
export { I as OriginalChampionTrophyIcon, I as OriginalChampionTrophy };
