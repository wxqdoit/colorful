...
import weights from "../defs/OriginalCourtyardHouse";

/** 合院 · 建筑 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalCourtyardHouseIcon";
export { I as OriginalCourtyardHouseIcon, I as OriginalCourtyardHouse };
