...
import weights from "../defs/OriginalSurveyTheodolite";

/** 经纬仪 · 科学 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSurveyTheodoliteIcon";
export { I as OriginalSurveyTheodoliteIcon, I as OriginalSurveyTheodolite };
