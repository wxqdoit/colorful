...
import weights from "../defs/OriginalFieldBinoculars";

/** 野外双筒镜 · 运动 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalFieldBinocularsIcon";
export { I as OriginalFieldBinocularsIcon, I as OriginalFieldBinoculars };
