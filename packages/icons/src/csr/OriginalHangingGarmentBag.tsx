...
import weights from "../defs/OriginalHangingGarmentBag";

/** 西服防尘袋 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHangingGarmentBagIcon";
export { I as OriginalHangingGarmentBagIcon, I as OriginalHangingGarmentBag };
