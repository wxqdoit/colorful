...
import weights from "../defs/OriginalCalligraphyBrush";

/** 毛笔 · 艺术 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalCalligraphyBrushIcon";
export { I as OriginalCalligraphyBrushIcon, I as OriginalCalligraphyBrush };
