...
import weights from "../defs/OriginalChopsticksRest";

/** 筷子与筷架 · 厨房 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalChopsticksRestIcon";
export { I as OriginalChopsticksRestIcon, I as OriginalChopsticksRest };
