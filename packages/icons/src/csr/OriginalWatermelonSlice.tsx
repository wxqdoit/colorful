...
import weights from "../defs/OriginalWatermelonSlice";

/** 西瓜切片 · 食物 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalWatermelonSliceIcon";
export { I as OriginalWatermelonSliceIcon, I as OriginalWatermelonSlice };
