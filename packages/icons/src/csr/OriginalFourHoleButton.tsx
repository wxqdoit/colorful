...
import weights from "../defs/OriginalFourHoleButton";

/** 四眼纽扣 · 手作 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalFourHoleButtonIcon";
export { I as OriginalFourHoleButtonIcon, I as OriginalFourHoleButton };
