...
import weights from "../defs/OriginalErlenmeyerFlask";

/** 锥形烧瓶 · 科学 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalErlenmeyerFlaskIcon";
export { I as OriginalErlenmeyerFlaskIcon, I as OriginalErlenmeyerFlask };
