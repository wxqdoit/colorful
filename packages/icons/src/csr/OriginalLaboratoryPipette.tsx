...
import weights from "../defs/OriginalLaboratoryPipette";

/** 移液器 · 科学 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalLaboratoryPipetteIcon";
export { I as OriginalLaboratoryPipetteIcon, I as OriginalLaboratoryPipette };
