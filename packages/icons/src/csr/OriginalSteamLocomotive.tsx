...
import weights from "../defs/OriginalSteamLocomotive";

/** 蒸汽火车 · 出行 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSteamLocomotiveIcon";
export { I as OriginalSteamLocomotiveIcon, I as OriginalSteamLocomotive };
