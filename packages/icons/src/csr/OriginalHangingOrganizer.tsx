...
import weights from "../defs/OriginalHangingOrganizer";

/** 悬挂布袋 · 家居 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHangingOrganizerIcon";
export { I as OriginalHangingOrganizerIcon, I as OriginalHangingOrganizer };
