...
import weights from "../defs/OriginalHangingEggChair";

/** 吊篮椅 · 家居 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHangingEggChairIcon";
export { I as OriginalHangingEggChairIcon, I as OriginalHangingEggChair };
