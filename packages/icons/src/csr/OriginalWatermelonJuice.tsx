...
import weights from "../defs/OriginalWatermelonJuice";

/** 西瓜汁 · 饮品 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalWatermelonJuiceIcon";
export { I as OriginalWatermelonJuiceIcon, I as OriginalWatermelonJuice };
