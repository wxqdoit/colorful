...
import weights from "../defs/OriginalKnottedHeadband";

/** 打结发箍 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalKnottedHeadbandIcon";
export { I as OriginalKnottedHeadbandIcon, I as OriginalKnottedHeadband };
