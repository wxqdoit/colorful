...
import weights from "../defs/OriginalConvertibleCar";

/** 敞篷跑车 · 出行 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalConvertibleCarIcon";
export { I as OriginalConvertibleCarIcon, I as OriginalConvertibleCar };
