...
import weights from "../defs/OriginalArtistPaintTube";

/** 颜料软管 · 手作 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalArtistPaintTubeIcon";
export { I as OriginalArtistPaintTubeIcon, I as OriginalArtistPaintTube };
