...
import weights from "../defs/OriginalFilmClapperboard";

/** 电影场记板 · 艺术 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalFilmClapperboardIcon";
export { I as OriginalFilmClapperboardIcon, I as OriginalFilmClapperboard };
