...
import weights from "../defs/OriginalManualCanOpener";

/** 手动开罐器 · 厨房 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalManualCanOpenerIcon";
export { I as OriginalManualCanOpenerIcon, I as OriginalManualCanOpener };
