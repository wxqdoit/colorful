...
import weights from "../defs/OriginalEmbroideryHoop";

/** 刺绣绷圈 · 手作 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalEmbroideryHoopIcon";
export { I as OriginalEmbroideryHoopIcon, I as OriginalEmbroideryHoop };
