...
import artwork from "../defs/LinkSimpleHorizontalBreak";

/** Link Simple Horizontal Break · 沟通 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={artwork} />);
I.displayName = "LinkSimpleHorizontalBreakIcon";
export { I as LinkSimpleHorizontalBreakIcon, I as LinkSimpleHorizontalBreak };
