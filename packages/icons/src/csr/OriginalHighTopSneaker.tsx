...
import weights from "../defs/OriginalHighTopSneaker";

/** 高帮帆布鞋 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHighTopSneakerIcon";
export { I as OriginalHighTopSneakerIcon, I as OriginalHighTopSneaker };
