...
import weights from "../defs/OriginalSidecarMotorcycle";

/** 边斗摩托 · 出行 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSidecarMotorcycleIcon";
export { I as OriginalSidecarMotorcycleIcon, I as OriginalSidecarMotorcycle };
