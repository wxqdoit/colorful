...
import weights from "../defs/OriginalBirdOfParadise";

/** 天堂鸟 · 植物 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalBirdOfParadiseIcon";
export { I as OriginalBirdOfParadiseIcon, I as OriginalBirdOfParadise };
