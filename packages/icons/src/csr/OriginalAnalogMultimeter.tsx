...
import weights from "../defs/OriginalAnalogMultimeter";

/** 指针万用表 · 科学 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalAnalogMultimeterIcon";
export { I as OriginalAnalogMultimeterIcon, I as OriginalAnalogMultimeter };
