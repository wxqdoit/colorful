...
import weights from "../defs/OriginalAnalogWristwatch";

/** 指针腕表 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <IconBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalAnalogWristwatchIcon";
export { I as OriginalAnalogWristwatchIcon, I as OriginalAnalogWristwatch };
