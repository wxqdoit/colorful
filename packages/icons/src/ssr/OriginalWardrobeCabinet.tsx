...
import weights from "../defs/OriginalWardrobeCabinet";

/** 双门衣柜 · 家居 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalWardrobeCabinetIcon";
export { I as OriginalWardrobeCabinetIcon, I as OriginalWardrobeCabinet };
