...
import weights from "../defs/OriginalHandheldVacuum";

/** 手持吸尘器 · 家居 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalHandheldVacuumIcon";
export { I as OriginalHandheldVacuumIcon, I as OriginalHandheldVacuum };
