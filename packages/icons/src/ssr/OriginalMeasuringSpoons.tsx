...
import weights from "../defs/OriginalMeasuringSpoons";

/** 量勺组 · 厨房 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalMeasuringSpoonsIcon";
export { I as OriginalMeasuringSpoonsIcon, I as OriginalMeasuringSpoons };
