...
import weights from "../defs/OriginalArcadeJoystick";

/** 街机摇杆 · 科技 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalArcadeJoystickIcon";
export { I as OriginalArcadeJoystickIcon, I as OriginalArcadeJoystick };
