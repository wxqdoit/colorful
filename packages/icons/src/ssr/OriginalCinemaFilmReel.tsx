...
import weights from "../defs/OriginalCinemaFilmReel";

/** 电影胶片盘 · 艺术 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalCinemaFilmReelIcon";
export { I as OriginalCinemaFilmReelIcon, I as OriginalCinemaFilmReel };
