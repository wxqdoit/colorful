...
import weights from "../defs/OriginalDomedObservatory";

/** 圆顶天文台 · 建筑 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalDomedObservatoryIcon";
export { I as OriginalDomedObservatoryIcon, I as OriginalDomedObservatory };
