...
import weights from "../defs/OriginalDaypackBackpack";

/** 日用双肩包 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalDaypackBackpackIcon";
export { I as OriginalDaypackBackpackIcon, I as OriginalDaypackBackpack };
