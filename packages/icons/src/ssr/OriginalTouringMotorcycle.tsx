...
import weights from "../defs/OriginalTouringMotorcycle";

/** 旅行摩托 · 出行 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalTouringMotorcycleIcon";
export { I as OriginalTouringMotorcycleIcon, I as OriginalTouringMotorcycle };
