...
import weights from "../defs/OriginalMushroomTableLamp";

/** 蘑菇台灯 · 家居 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalMushroomTableLampIcon";
export { I as OriginalMushroomTableLampIcon, I as OriginalMushroomTableLamp };
