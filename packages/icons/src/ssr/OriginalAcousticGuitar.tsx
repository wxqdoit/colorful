...
import weights from "../defs/OriginalAcousticGuitar";

/** 木吉他 · 艺术 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalAcousticGuitarIcon";
export { I as OriginalAcousticGuitarIcon, I as OriginalAcousticGuitar };
