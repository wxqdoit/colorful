...
import weights from "../defs/OriginalManualHandDrill";

/** 手摇钻 · 手作 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalManualHandDrillIcon";
export { I as OriginalManualHandDrillIcon, I as OriginalManualHandDrill };
