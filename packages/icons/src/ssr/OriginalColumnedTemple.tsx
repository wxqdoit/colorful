...
import weights from "../defs/OriginalColumnedTemple";

/** 柱廊神殿 · 建筑 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalColumnedTempleIcon";
export { I as OriginalColumnedTempleIcon, I as OriginalColumnedTemple };
