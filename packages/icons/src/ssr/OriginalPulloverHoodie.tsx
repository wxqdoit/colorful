...
import weights from "../defs/OriginalPulloverHoodie";

/** 连帽卫衣 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalPulloverHoodieIcon";
export { I as OriginalPulloverHoodieIcon, I as OriginalPulloverHoodie };
