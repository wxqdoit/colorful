...
import weights from "../defs/OriginalSurveyorsLevel";

/** 水准仪 · 科学 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSurveyorsLevelIcon";
export { I as OriginalSurveyorsLevelIcon, I as OriginalSurveyorsLevel };
