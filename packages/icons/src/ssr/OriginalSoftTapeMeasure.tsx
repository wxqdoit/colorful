...
import weights from "../defs/OriginalSoftTapeMeasure";

/** 软尺 · 手作 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalSoftTapeMeasureIcon";
export { I as OriginalSoftTapeMeasureIcon, I as OriginalSoftTapeMeasure };
