...
import weights from "../defs/OriginalDrinkingFountain";

/** 饮水台 · 建筑 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalDrinkingFountainIcon";
export { I as OriginalDrinkingFountainIcon, I as OriginalDrinkingFountain };
