...
import weights from "../defs/OriginalEyeshadowPalette";

/** 眼影盘 · 个护 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalEyeshadowPaletteIcon";
export { I as OriginalEyeshadowPaletteIcon, I as OriginalEyeshadowPalette };
