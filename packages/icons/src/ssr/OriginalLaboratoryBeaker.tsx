...
import weights from "../defs/OriginalLaboratoryBeaker";

/** 烧杯 · 科学 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalLaboratoryBeakerIcon";
export { I as OriginalLaboratoryBeakerIcon, I as OriginalLaboratoryBeaker };
