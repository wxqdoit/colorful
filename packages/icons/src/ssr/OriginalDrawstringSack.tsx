...
import weights from "../defs/OriginalDrawstringSack";

/** 抽绳束口袋 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalDrawstringSackIcon";
export { I as OriginalDrawstringSackIcon, I as OriginalDrawstringSack };
