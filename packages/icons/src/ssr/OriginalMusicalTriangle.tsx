...
import weights from "../defs/OriginalMusicalTriangle";

/** 三角铁 · 艺术 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalMusicalTriangleIcon";
export { I as OriginalMusicalTriangleIcon, I as OriginalMusicalTriangle };
