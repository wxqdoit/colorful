...
import weights from "../defs/OriginalFoldedPaperCrane";

/** 折纸鹤 · 手作 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalFoldedPaperCraneIcon";
export { I as OriginalFoldedPaperCraneIcon, I as OriginalFoldedPaperCrane };
