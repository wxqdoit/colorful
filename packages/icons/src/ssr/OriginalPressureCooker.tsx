...
import weights from "../defs/OriginalPressureCooker";

/** 高压锅 · 厨房 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalPressureCookerIcon";
export { I as OriginalPressureCookerIcon, I as OriginalPressureCooker };
