...
import weights from "../defs/OriginalElectricGuitar";

/** 电吉他 · 艺术 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalElectricGuitarIcon";
export { I as OriginalElectricGuitarIcon, I as OriginalElectricGuitar };
