...
import weights from "../defs/OriginalCrossbodyPurse";

/** 斜挎小包 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalCrossbodyPurseIcon";
export { I as OriginalCrossbodyPurseIcon, I as OriginalCrossbodyPurse };
