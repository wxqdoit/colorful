...
import weights from "../defs/OriginalDoubleDeckerBus";

/** 双层巴士 · 出行 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalDoubleDeckerBusIcon";
export { I as OriginalDoubleDeckerBusIcon, I as OriginalDoubleDeckerBus };
