...
import weights from "../defs/OriginalManualToothbrush";

/** 手动牙刷 · 个护 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalManualToothbrushIcon";
export { I as OriginalManualToothbrushIcon, I as OriginalManualToothbrush };
