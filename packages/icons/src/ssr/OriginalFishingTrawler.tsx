...
import weights from "../defs/OriginalFishingTrawler";

/** 拖网渔船 · 出行 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalFishingTrawlerIcon";
export { I as OriginalFishingTrawlerIcon, I as OriginalFishingTrawler };
