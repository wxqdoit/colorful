...
import weights from "../defs/OriginalNutcrackerTool";

/** 夹壳钳 · 厨房 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalNutcrackerToolIcon";
export { I as OriginalNutcrackerToolIcon, I as OriginalNutcrackerTool };
