...
import weights from "../defs/OriginalUtilityJumpsuit";

/** 连体工装 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalUtilityJumpsuitIcon";
export { I as OriginalUtilityJumpsuitIcon, I as OriginalUtilityJumpsuit };
