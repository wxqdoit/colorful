...
import weights from "../defs/OriginalGraduatedCylinder";

/** 量筒 · 科学 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalGraduatedCylinderIcon";
export { I as OriginalGraduatedCylinderIcon, I as OriginalGraduatedCylinder };
