...
import weights from "../defs/OriginalLaboratoryBalance";

/** 实验天平 · 科学 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalLaboratoryBalanceIcon";
export { I as OriginalLaboratoryBalanceIcon, I as OriginalLaboratoryBalance };
