...
import weights from "../defs/OriginalRailwayPlatform";

/** 铁路站台 · 建筑 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalRailwayPlatformIcon";
export { I as OriginalRailwayPlatformIcon, I as OriginalRailwayPlatform };
