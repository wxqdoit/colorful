...
import weights from "../defs/OriginalRubberRainBoot";

/** 橡胶雨靴 · 穿搭 */
const I: Icon = forwardRef((props, ref) => <SSRBase ref={ref} {...props} weights={weights} />);
I.displayName = "OriginalRubberRainBootIcon";
export { I as OriginalRubberRainBootIcon, I as OriginalRubberRainBoot };
